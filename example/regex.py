...
text2 = "이메일은 text@example.com 또는 hello@domain.co.kr로 보내주세요."
...
print("3. 숫자 찾기: ", numbers)

text4 = "연락처는 010-1234-5678입니다."
phone_pattern = r"^\d{3}-\d{4}-\d{4}$"
print("4. 전화번호 형식 확인:", "올바른 형식" if re.match(phone_pattern, text4) else "잘못 된 형식")